...
class DenoisingXPIETestDataset(Dataset):
    def __init__(self, original_dir, filtered_dir, phase='train', target_filter='beta_10_H_5_',\
                 test_noise_level=0, test_blur_level=0, test_noise_mode='gaussian'):
        ...
        if self.phase == 'train':
            self.image_filenames = self.image_filenames[201:]
        elif self.phase == 'val':
            self.image_filenames = self.image_filenames[101:200]
        else:
            self.image_filenames = self.image_filenames[0:100]
    ...
    def __getitem__(self, idx):
        ...
        if self.phase == 'train':
            ...
            # original and filtered images are resized to same size. Only required for JNU dataset
